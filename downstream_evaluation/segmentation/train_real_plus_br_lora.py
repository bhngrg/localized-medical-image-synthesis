...
OUTPUT_ROOT = (
    ...
    / "real_plus_br_lora_seed42_a30_normal_q"
)
...
def main() -> None:
    ...
    if len(synthetic_train_dataset) != 10000:
        raise RuntimeError(
            "Expected exactly 10,000 synthetic training slices."
        )
    ...
    print()
    print("Starting real + BR-LoRA downstream training.")
